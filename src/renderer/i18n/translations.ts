...
export const translations = {
  en: {
    ...
    automation: {
      ...
      requiresCsv: 'Load a CSV file first',
      requiresCredentials: 'Enter your credentials',
    },
    csv: {
      title: 'CSV Editor',
  ...
  es: {
    ...
    updates: {
      ...
      timeout: 'La verificación de actualizaciones expiró',
      install: 'Instalar',
    ...
    automation: {
      ...
      requiresCsv: 'Carga un archivo CSV primero',
      requiresCredentials: 'Ingresa tus credenciales',
    },
    csv: {
      title: 'Editor CSV',
    ...
    logsExt: {
      ...
      legend: 'Leyenda',
      viewDetails: 'Ver mensaje completo',
