 ...
 * Shows connection status and monitors network state
 */
...
export function NetworkStatusIndicator({
  ...
  // Initialize with navigator.onLine to avoid sync setState in effect
  ...
  const checkConnection = useCallback(async () => {
    ...
    try {
      ...
      // We use a reliable endpoint and add a cache-busting parameter
  ...
  // Set up listeners and periodic checks
  useEffect(() => {
    const handleOnline = () => {
      setStatus('online');
      setLastChecked(new Date());
    ...
    // Start periodic check after a short delay (to avoid sync setState)
...
/**
 * useNetworkStatus hook - Provides network status state
 */
...
/**
 * Network Error Banner - Shows when offline
 */
