...
const DEFAULT_TEMPLATES: CSVTemplate[] = [
  {
    ...
    data: [
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
  ...
  },
  {
    ...
    data: [
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: 'CUENTA2:PROYECTO2:09:00-13:00' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: 'CUENTA2:PROYECTO2:09:00-13:00' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
  ...
  },
  {
    ...
    data: [
      ...
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'CUENTA', proyecto: 'PROYECTO', extras: '' },
      { cuenta: 'FDS', proyecto: 'FDS', extras: '' },
      { cuenta: 'FDS', proyecto: 'FDS', extras: '' },
    ],
    createdAt: Date.now(),
    updatedAt: Date.now(),
